"""
Django settings for SisCrown project.
...
SECRET_KEY = 'c&4^1*lewlw9_m_46lhzsx@0+#jqkfx)0sz94i)z(2)cv^hd+c'
...
WSGI_APPLICATION = 'SisCrown.wsgi.application'
