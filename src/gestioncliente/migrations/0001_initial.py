...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('usuario', '0002_auto_20170712_1703'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('anonimo', models.CharField(blank=True, max_length=50)),
                ...
                ('fecha_creacion', models.DateTimeField(default=django.utils.timezone.now)),
                ('agencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuario.Agencia')),
                ('dni', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='cliente.Cliente')),
